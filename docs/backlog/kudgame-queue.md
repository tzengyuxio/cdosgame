...
### B2 — 戀愛物語＋夢幻西餐廳
- [ ] 戀愛物語2 — cdg-1804 — 補完（第三波更新檔）
- [ ] 夢幻西餐廳：媚力夜總會 — cdg-2751 — 補完
- [ ] 夢幻西餐廳：決戰全台灣 — cdg-2752 — 補完
- [ ] 夢幻西餐廳2：挑戰全世界 — cdg-2753 — 補完
- [ ] 夢幻西餐廳2：美國星期五餐廳 — cdg-2754 — 補完
...
### B3 — EVA 新世紀福音戰士
- [ ] 綾波育成計劃 — cdg-2316 — 補完（華義 2001）
- [ ] 機密檔案 — cdg-2315 — 補完（光譜，>2002）
- [ ] 鋼鐵 Girl Friend — cdg-2317 — 補完＋訂正（原初 1997/GAINAX/華義；剝離英特衛 2nd 別名）
- [ ] 碇真嗣育成計劃 — 新建（光譜）
- ~~鋼鐵戀人新章 — 英特衛 >2001 → 不建~~

### B4 — 新建＋夢幻模擬戰
- ~~鋼鐵戀人特別篇 — 英特衛 >2001 → 不建~~
- [ ] 夢幻模擬戰1 — cdg-2741 — 補完（Career 2001）
- [ ] 夢幻模擬戰2 — cdg-2742 — 補完
- [ ] 夢幻模擬戰3 — cdg-2743 — 補完（遊戲橘子）
- [ ] 公主的回憶 — 新建（華義 H-GAME 18禁）
