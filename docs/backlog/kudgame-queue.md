...
- [ ] 叮噹五福星 — cdg-0928 — 補完（亞博克 2003 SRPG）
- [ ] 武林盟主 — cdg-4405 — 補完（dev/year/genre 全待考；注意與 cdg-0739 決戰中原 區分）
- [ ] 女神天蠶變 — cdg-1072 — 補完（三協 2002，genre 待補）
- [ ] 模擬百貨 — cdg-3194 — 補完（智冠 2002 LSG）
...
- [ ] 蜀山外傳：紫青劫 — cdg-2842 — 補完（智冠 2002 RPG）
