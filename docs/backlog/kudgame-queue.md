...
### D1 — 武俠補完
- [ ] 達摩 — cdg-2586 — 補完（大點科技/1999/RPG，SCD2802）
- [ ] 龍虎門 — cdg-3830 — 補完（亞洲博克/2004/RPG，SCD0369；注意廠商名正規化 亞博克/亞洲博克/AceBrock）
- [ ] 天龍八部 — cdg-0482 — 補完（智冠/2002）⚠ **素材疑誤掛**：images/fandom ref 全指向 cdg-0481（歡樂盒/1997），補完前先做來源歸位
- [ ] 鹿鼎記2 — cdg-1983 — 補完（智冠/2000 stub；與 cdg-1984 歡樂盒/1998《鹿鼎記2：神龍教》為不同作）
- [ ] 如來神掌之宇宙爭雄 — cdg-1077 — 補完（智冠/2003/RPG，SCD0066）
