...
- [ ] 獨立戰爭（中文版）— cdg-3540 — G092
- [ ] 大航海時代II（中文版）— cdg-0419 — G094
- [ ] 項劉記（中文版）— cdg-3915 — G098
- [ ] 三國志IV（中文版）— cdg-0213 — G100（＋預告 IV威力加強版同條）
- [ ] 百戰水管工（中文版）— cdg-3842 — G105
- [ ] 太閤立志傳（中文版）— cdg-0503 — G106
- [ ] A列車4（中文版）— cdg-0040 — G108
- [ ] 航空霸業II（中文版）— cdg-0861 — G110
- [ ] 霸王傳（中文版）— cdg-1640 — G111
- [ ] 龍之封印 — cdg-5269 — G096（跨SKU，並列磁片碼）
- [ ] 米格廿九支點戰鬥機 — cdg-4914 — G099（MiG-29 Fulcrum，≠cdg-5291任務片）
- [ ] 幽浮 — cdg-4209 — G101
- [ ] 殖民帝國・美麗新世界 — cdg-4249 — G103（美麗新世界＝行銷副標非資料片）
- [ ] 魔法大帝 — cdg-4276 — G104
- [ ] 飛虎戰將 — cdg-5272 — G109
- [ ] 楚留香傳奇（中文版）— cdg-3108 — G112
- [ ] 運輸大亨 — cdg-2583 — G114（＋G115 異星殖民篇=Deluxe 火星圖檔擴充，併入）
- [ ] 拂曉巡弋 — cdg-5274 — G116
- [ ] 幽浮2－深海出擊 — cdg-0601 — 預告
- [ ] 三國志英傑傳 — cdg-0229 — 預告

**[ ] 既有空 stub → 補完＋publish**
- [ ] 光榮戰役 — cdg-4203 — G095 — Fields of Glory/MicroProse 1993（≠cdg-1155 Pacific Gunner）
- [ ] 雷電 — cdg-2681 — G097 — Raiden/Seibu

**[ ] 既有未發佈 stub → 只補 G-code 足跡，維持 published:false**
- [ ] 狂飆武士 — cdg-5270 — G107
- [ ] 夢魘 — cdg-5248 — G113
- [ ] 1942太平洋空戰 — cdg-5284 — G102（跨SKU 磁片碼）

**[ ] 新建**
- [ ] 武士戰弈 — cdg-5298 — G093 — 查無足跡 stub false
