...
### 補完（既有 stub [ ]，pub=false）
- [ ] 太空戰士７（最終幻想7）— cdg-2486 — Square（active，非 rejected；台灣代理足跡待查）
- [ ] 太空戰士８（最終幻想8）— cdg-2487 — Square
- [ ] 熱血躲避球 — cdg-3312 — 捷友/2000
- [ ] 熱血躲避球２《更新檔》— cdg-3313 — 捷友/2001（「更新檔」＝光碟附修正檔，同款不另建）
- [ ] 傲世蒼龍－趙雲傳 — cdg-1667 — 捷友/2002（庫名 傲世蒼龍之趙雲傳）
- [ ] 三國麻將風雲 — cdg-0259 — 捷友/1998
- [ ] 三國志－蜀漢英雄傳 — cdg-0231 — 安峻/1997（庫名 三國志蜀漢英雄傳）
- [ ] 斷劍傳說－聖戒風雲 — cdg-4391 — dev null 待補（清單標安峻）
- [ ] 梭哈俄羅斯 — cdg-3097 — dev Sweetleaf vs 清單安峻 待核/2000
- [ ] 手談 — cdg-2942 — 晟業（＝初段手談）/2005
- [ ] 圍棋習遊記 — cdg-1063 — 晟業/2002
- [ ] 圍棋習遊記２ — cdg-1064 — 晟業（＝圍棋習遊記：初學篇？待核）/2003
- [ ] 圍棋爭霸 — cdg-3098 — 晟業（棋侶：圍棋爭霸）/2005
...
- [ ] 象棋路邊攤 — cdg-2155 — 晟業/1998
- [ ] 雀美眉寫真館 — cdg-1963 — 詮積/2000
- [ ] 三國霸業 — cdg-0255 — 詮積（三國霸業1）/2000
- [ ] 三國霸業２ — cdg-0256 — 詮積/2003
- [ ] 百萬大富翁 — cdg-0836 — 尼奧科技/2001
- [ ] 少林麻將 — cdg-0547 — 尼奧科技/2002
- [ ] 報數！三國演義 — cdg-0783 — 尼奧/2002
- [ ] 八年抗戰 — cdg-0167 — 尼奧/2001
- [ ] 獵豔大富翁（＊18禁）— cdg-3549 — dev 大野狼工作室 vs 清單詮積 待核，adult

### 新建（[ ]，id 鎖 cdg-5155～5162）
- [ ] 藍調情人 — cdg-5155 — 捷友（查無足跡則 unverified stub）
- [ ] 圍棋封神榜 — cdg-5156 — 晟業
- [ ] 中國陸軍棋 — cdg-5157 — 晟業（庫內陸軍棋三款皆非此名，新建）
- [ ] 企鵝瑪力歐 — cdg-5158 — 尼奧
...
- [?] NBA LIVE 98 — cdg-5164（預留）— 同上

### 維持 reject
- ~~我的野蠻麻將 — cdg-1129 — 維持 reject（麻將 shovelware，使用者 2026-07-16 裁決不復活）~~

#### 批次規劃（每批 build 完 commit＋更新狀態）
- E1 太空戰士：cdg-2486、2487
- E2 捷友：cdg-3312、3313、1667、0259、5155
- E3 安峻：cdg-0231、4391、3097
- E4 晟業圍棋/手談：cdg-2942、1063、1064、3098、5156
- E5 晟業象棋：cdg-2152、2153、2154、2150、2156 ✅ content 99610a22（全 published，TBG，chiuinan 唯一來源）
- E6 晟業棋類收尾：cdg-2155、5157
- E7 詮積：cdg-1963、0255、0256、3549
- E8 尼奧補完：cdg-0836、0547、0783、0167
