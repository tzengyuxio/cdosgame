...
### D2 — 黃易/溫瑞安補完
- [ ] 尋秦記 — cdg-1709 — 補完（南晶科技/智冠電子/2001/RPG，SCD0959；**補 adult: true**）
- [ ] 破碎虛空 — cdg-4289 — 補完（北斗星工作室/智冠/1999-08-15/Windows/4CD/RPG，黃易小說改編；庫內僅存別名「G038-破碎虛空」）
- [ ] 大唐雙龍傳 — cdg-0357 — 補完（次方科技/2001/RPG，SCD1113）
- [ ] 四大名捕之會京師 — cdg-1023 — 補完（**先查證發行商**：庫內記第三波/2005 vs 清單智冠 vs chiuinan SCD0738）
- [ ] 四大名捕之鐵手無敵 — cdg-1024 — 補完（**先查證發行商**：庫內記第三波/2004/ACT vs chiuinan SCD0737）
