...
- [ ] 神秘的世界 — cdg-5147 — 新建（富峰群）
- [ ] 時空戀人 — cdg-5148 — 新建（富峰群）
- [ ] 退魔傳說 — cdg-5149 — 新建（遊戲橘子；與 cdg-3366/3367 學園退魔傳 非同款）
- [ ] 烈焰奇兵 — cdg-5150 — 新建（遊戲橘子，Master Blaze；與 cdg-0923 古神之印 Elder Blaze 同系列）

### B17 — 新建 2
- [ ] ＲＰＧ夢工廠 — cdg-5151 — 新建（遊戲橘子；決策：即使為工具軟體照建）
- [ ] 便利商店精裝版 — cdg-5152 — 新建（合輯：便利商店＋速食店＋火鍋店）
...
- [ ] **RPG夢工廠** — **待查、勿單獨判死**（遊戲橘子發行、類型欄標「其它」；`12.htm` @20010207204920）。原頁逐字「利用『RPG夢工廠』玩家可以自己創造一個完完全全屬於自己的RPG」＝**RPG 製作工具**（RPG Maker 類）→ 依「工具軟體不收」傾向排除、比照 cdg-5135《遊戲天堂》不建先例。⚠ **但有反向先例**：同為「其它」類的 **cdg-0524《小秘書Lina》（桌面助理工具外殼）本批已收並 published: true**（理由：有劇情/CG/聲優/好感度養成，PIM 僅為外殼）。**建議與 cdg-0524 一併決定「遊戲橘子非遊戲產品」的一致處置**。⚠ 注意本款即 **B17 的 cdg-5151「ＲＰＧ夢工廠」**（queue 既有決策為「即使為工具軟體照建」）——兩個決策**互相衝突**，B17 動工前需裁決。
