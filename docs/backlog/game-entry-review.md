...
- [ ] **cdg-0169 developer「Mips」與實際開發團隊「가람과 바람」的歸屬**：게임메카〈[90년대 게임광고] 원작서 못 낸 완결 게임으로, 8용신전설〉（류종화，2021-05-18，n.news.naver.com/article/356/0000047027，內含《PC챔프》1997-11～1998-05 當期廣告掃圖）明載——**首波廣告（1997-11 號）開發商標「가람과 바람」，1998-02 號上市廣告改標「밉스 소프트웨어」**，其後兩方失和、가람과 바람轉投카마 엔터테인먼트；나무위키亦記「가람과 바람에서 제작하고 밉스소프트에서 배급」（製作／發行分屬兩方）。frontmatter `developer` 保守沿用既有字串 `Mips`（chiuinan 記法，亦即上市時的掛名），가람과 바람僅寫入正文。**`dev_team` 留 null**：該團隊是否為 Mips 廠內編制無定論（失和後出走，較像合作外包），且 /teams 頁現況以台灣團隊為主，未貿然建值。公司全名「밉스 소프트웨어／Mips Software」僅見韓方來源，未改寫 developer 欄以免拆散 facet。
...
- [ ] **cdg-0169 韓文人名未漢字化、劇中專名未寫入**：依 skill「署名照 credit 原樣、勿把假名／外文名漢字化」，作者記 `박성우`（Park Sung-woo）、團隊成員記 `김무광`，未取漢字寫法。原作專名（공존계／카드무스／진룡／천마뇌제）雖有明顯漢字對應（疑為共存界／真龍／天魔雷帝等），**無來源佐證故未寫入正文**，劇情僅作去專名的概述。`staff` 全數未填——박성우「插畫與監修」的參與雖有來源，但依 staff 收錄範圍（外商作品一般開發人員不入、日韓歐美限知名人士）判定不入，其角色改於正文陳述。
