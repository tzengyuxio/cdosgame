...
- [x] 三國群俠傳 cdg-5140 developer「東方演算」 — **已裁決（2026-07-15，使用者）：用東方演算，前身為河洛工作室**。經百度百科（使用者提供）確認沿革：河洛工作室 1993 年成立、原為智冠遊戲開發組，《武林群俠傳》後徐昌隆帶隊脫離智冠另立**東方演算（Oriental Algorithm System）**，《三國群俠傳》為其成立後第一款作品、「群俠三部曲」最後一部；該作銷量不理想加上盜版猖獗，徐昌隆決定解散公司（2006），原成員 2014 年重組後推出《俠客風雲傳》《俠隱閣》。**「慣例衝突」實為假象**：cdg-1626/1627/1706 用「河洛工作室」正確（河洛時期作品）、cdg-5140 用「東方演算」亦正確（改組後作品），兩者為同一團隊不同時期的實體、不需統一。已補百度百科為第二來源並在正文補述沿革。**後續可考慮**：依 `docs/backlog/company-aliases.md` 的「改名傳承」機制登記 河洛工作室→東方演算（目前兩者皆無 `content/companies/` 頁，僅純文字）（2026-07-15）
