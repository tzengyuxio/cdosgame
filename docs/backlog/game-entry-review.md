...
- [ ] 三國群俠傳 cdg-5140 developer「東方演算」vs repo 慣例「河洛工作室」 — 查證：河洛團隊離開智冠後**已重新設立公司並更名**，2002 年本作推出時「河洛工作室」名義並不存在，故填 `developer: 東方演算`（智冠僅為發行商，「非智冠自製」確立）。**但這偏離 repo 既有慣例**：cdg-1706/1626/1627 皆用「河洛工作室」、全庫無條目用「東方演算」→ 會造成 /companies/ 聚合分裂。待裁決統一寫法（東方演算 vs 河洛工作室 vs 加 alias 映射）。另 `data/basematch-decisions.json` 的 `"G244-三國群俠傳": reject`（理由 "possibly fan game"）明顯有誤、已被本條目取代，可順手清掉（2026-07-15）
