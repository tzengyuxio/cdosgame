# kudgame 批次補完完成史（唯讀歸檔）

kudgame 批次補完/新建條目的**完成史**，逐批保留 commit hash 與「本批完成」總結，供回溯。

- **active 佇列**（下一批要處理的）：[kudgame-queue.md](kudgame-queue.md)
- **專案級後續待辦**（alias／topic 頁／series 缺口）：[kudgame-followups.md](kudgame-followups.md)
- **逐條 cdg 欄位待核疑點**的正主：[game-entry-review.md](game-entry-review.md)

> 📌 本檔唯讀。最後一批「英特衛/右將…」的 triage 清單原以 `[ ]` 列出，實際都已由同批 `M1–M5＋R0` build 完成——歸檔時已翻牌為 `[x]`，逐款結論見該批〈批次規劃〉。

**狀態圖例**：`[x]` 完成（補完或新建，已 publish）｜`[~]` 略過（已存在且已發佈）｜`[!]` 建 stub（查無足跡，unverified）
...
### reject
- [x] 古劍奇譚1：琴心劍魄今何在 — cdg-0903 — game-triage reject（2010 >DOS era、英特衛>2001）

### 補完（既有 stub [ ]，pub=false）
- [x] 末日黎明 — cdg-3072（2001/NMG/英特衛/SRPG，2001 邊界可收）
- [x] 天命傳奇 — cdg-0454（2001/Arxel Tribe/英特衛，2001 邊界可收）
- [x] 鐵甲紀元：戰魂 — cdg-3601（1997/新意）
- [x] 星際大亨 — cdg-2408（1995/九藝/TBG）
- [x] 薛家將徵東神話 — cdg-4066（1998）
- [x] 鼓惑人心 — cdg-2284（2000/右將）
- [x] 超能力 — cdg-5095（右將，year null，前批 stub id）
- [x] 大富翁之城市英雄 — cdg-0378（1997/美夢成真/TBG）
- [x] 美女拳 — cdg-1465（1991/尋夢園）
- [x] 美女水果盤 — cdg-1469（1993/寶貝貓，18禁）
- [x] 火狐狸 — cdg-4058（1997/火狐狸工作室；⚠與 cdg-5034 EA 1984《火狐狸》、cdg-4687 Dynamix《火狐狸2》撞名、非同款）
- [x] One Must Fall 2097＝機甲旋風 — cdg-4244（1994/Epic MegaGames）
- [x] 光速兔崽子 — cdg-1681（1994/Epic，Jazz Jackrabbit）
- [x] 光速兔崽子2 — cdg-1682（1998/Epic）
- [x] Porntris＝性俄羅斯 — cdg-1745（1993/Image Line，真人 18禁）

### 新建候選（[ ]，查無 catalog；id build 時逐一鎖定 cdg-5219+）
- [x] 巫毒小子/Voodoo Kid — 英特衛，研究年份定收否（Voodoo Kid 約 1997）
- [x] 魔女隨堂測驗 — 英特衛，研究年份定收否
- [x] 風之翼 — 英特衛，研究年份定收否
- [x] 倉庫工人 — 洛凡妮莎工作室（DOS 倉庫番/Sokoban）
- [x] 丁丁在西藏/Tintin in Tibet — Infogrames（1996 外文進口）
- [x] BARYON — ACRO（韓製射擊，外文進口）
- [x] Cool Spot 七喜小子 — Virgin（1993 外文進口）
- [x] Grand Prix 500 2 風速小子 — Microids（cdg-0079 為初代 GP500 摩托賽）
- [x] World Cup USA 94 — US Gold（1994 外文進口）
- [x] Super Bubble Pop 超級立體泡泡 — 外文進口
...
- [x] M4 新建：巫毒小子、魔女隨堂測驗、風之翼、丁丁在西藏、倉庫工人 ✅ content 9421db05／registry c091c1d2（**5 款→2 建＋3 未建**）：cdg-5219 巫毒小子＝Voodoo Kid/Infogrames FR 1997 點擊冒險，查無台灣代理→foreign published:false；cdg-5223 倉庫工人＝洛凡妮莎工作室 DOS 推箱子 PZG，單一來源 kudgame→unverified published:false。**cdg-5220 魔女隨堂測驗＝2010（>2001）SKIP**（英特衛規則）、id 保留未用；**cdg-5221 風之翼查無定論 SKIP**、id 保留未用；**丁丁在西藏未建**——查出已是既有 reject cdg-0149（整個丁丁系列 0149/0150/0151 因外文無台灣中文化足跡 reject），維持 reject 不復活（⚠待使用者確認是否翻案）。待核：cdg-5223 developer 洛凡妮莎工作室單一來源、cdg-5219 英特衛台灣代理未證。
- [x] M5 新建：BARYON、Cool Spot、GP500-2、World Cup USA 94、Super Bubble Pop ✅ content 43fbc5b5／registry cff8775d（**5 款→3 新建＋1 補完既有＋1 棄用重複**）：cdg-5224 BARYON＝韓 ACRO STG foreign stub；cdg-5225 七喜小子＝Virgin Cool Spot ACT foreign stub（姊妹作 cdg-4895 已連）；cdg-5228 超級立體泡泡＝2002 消除益智、無 DOS 版·身分待證 unverified stub。**GP500-2 風速小子＝cdg-0079 重複**（cdg-0079 GP500摩托賽本身即 Grand Prix 500 2、別名已含風速小子；triage「初代/續作」假設錯誤）→ cdg-5226 棄用（未登 registry）。**World Cup USA 94＝既有 cdg-4457「94美國世界盃」同款**→ 補完 cdg-4457（Tiertex/US Gold 1994 SPG foreign）、cdg-5227 棄用。待核：cdg-5225 若查得歐風引進可升 packaging published；cdg-5228 中文名對應待證。
...
- [x] 艦隊指揮官 — cdg-0864 — 補完（Jane's Fleet Command、美商藝電、RTS、localized）
- [~] 銀河戰國列傳/Schwarzschild — cdg-2898→cdg-4074 — **併入**（研究確認同款：chiuinan c32/sch.htm 講的就是 EX 鐵鎖的星群，系列正傳無 1995 作；2898 aliases 自承 EX。cdg-2898 merged_into cdg-4074，SCD0228＋chiuinan 圖轉掛保留方）⟵ Batch 3
- [x] SEGA越野冠軍賽2 — cdg-0640 — 補完（Sega Rally 2、億弘、RCG packaging/en、title 清理為世嘉拉力賽2）
