...
- [ ] cdg-4173「3D立體彈子檯」Tristan 別名疑誤掛 — build 判定與 cdg-3025（彈子檯＝Littlewing Tristan 2D 單畫面）非同款；4173 名「3D 立體」與 Tristan 2D 本質矛盾，其 `Tristan Solid State Pinball` 別名來自 boneash@merge 自動合併、無碼佐證，待複查移除別名
