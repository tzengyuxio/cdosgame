...
## press 批遺留的待人工複查（frontmatter，依鐵律未改）

| 條目 | 欄位 | 現值 → 報導值 | 建議 |
|---|---|---|---|
| cdg-5244 夢幻占星館 | `publisher_tw` | `[KIWI]` → 軟世70+71「出版公司未定」（KIWI 僅製作公司） | 建議改 `null`（**待使用者確認**） |
| cdg-4387 戰國群英 | `publisher_tw` | `[立東]`（原標待查證）→ 軟世40 佐證立東屬實 | 正文已更新；可移除待查證措辭 |
| cdg-2449 時空英豪 | 系統需求 | 正文 P3 ← 報導 Appeal 上市前宣稱 P200MMX | 正文已並陳「上市前廠商宣稱」 |
| cdg-5215 美夢成真 | 首段角色定位 | 「經紀公司雜誌編輯」← 報導「記者、非經紀人」 | 可複查首段措辭 |
