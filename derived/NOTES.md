...
5. 量夠後反推 schema（已浮現 catalog 欄位：title_zh / title_aliases / year / developer / developer_region / publisher_tw / content_language / genre / localization_level / size / platform_note / catalog_id / cover / images{chiuinan[],rwv_cover,fandom} / references{omega,fandom} / external_links / provenance）。
